...
mod tests {
    ...
    fn test_create_game() {
        ...
        let game = Game::create(game_id.clone(), unit_ids);
    ...
    fn test_advance_to_next_turn() {
        ...
        let mut game = Game::create(game_id, unit_ids);
        assert_eq!(game.current_turn_number().value(), 1);
    ...
    fn test_advance_turn_when_game_finished() {
        ...
        let mut game = Game::reconstruct(game_id, unit_ids, current_turn_number);
    ...
    fn test_contains_unit() {
        ...
        let game = Game::create(game_id, unit_ids);
    ...
    fn test_game_equality() {
        ...
        let game2 = Game::reconstruct(game_id.clone(), unit_ids, current_turn_number);
