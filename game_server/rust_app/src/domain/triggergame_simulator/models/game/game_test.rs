...
mod tests {
    ...
    fn test_create_game() {
        ...
        let game = Game::create(game_id.clone());
    ...
    fn test_advance_to_next_turn() {
        ...
        let mut game = Game::create(game_id.clone());
        assert_eq!(game.current_turn_number().value(), 1);
    ...
    fn test_advance_turn_when_game_finished() {
        ...
        let mut game = Game::reconstruct(game_id, current_turn_number);
        assert!(game.is_game_finished());
    ...
    fn test_reconstruct_game() {
        ...
        let game = Game::reconstruct(game_id.clone(), current_turn_number.clone());
    ...
    fn test_game_equality() {
        ...
        let game1 = Game::reconstruct(game_id.clone(), current_turn_number.clone());
        let game2 = Game::reconstruct(game_id.clone(), current_turn_number.clone());
