...
pub struct FriendUnitDto {
    ...
    pub having_main_trigger_ids: Vec<TriggerId>,
    pub having_sub_trigger_ids: Vec<TriggerId>,
...
impl FriendUnitDto {
    ...
    fn to_friend_unit_data(unit: &Unit) -> Self {
        FriendUnitDto {
            ...
            having_main_trigger_ids: unit.having_main_trigger_ids().value().clone(),
            having_sub_trigger_ids: unit.having_sub_trigger_ids().value().clone(),
