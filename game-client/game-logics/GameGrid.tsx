...
import { playerCharacterKeys, playerPositions } from "./config/CharacterConfig";
...
const GameGrid = () => {
  ...
  useEffect(() => {
    const handleTurnResultSubmitted = (data: WebSocketResponseType) => {
      if (data.action === "turnActionsResult") {
    ...
    addMessageListener("turnActionsResult", handleTurnResultSubmitted);

    return () => {
      removeMessageListener("turnActionsResult", handleTurnResultSubmitted);
    };
